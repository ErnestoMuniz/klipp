...
export const formSelectClass =
  "cursor-pointer rounded-sm border border-(--border) bg-(--surface-sunk) px-3 py-2.5 text-sm text-(--text-h) shadow-(--inset-lo) hover:not-disabled:border-(--accent-border) disabled:cursor-not-allowed disabled:opacity-55";
