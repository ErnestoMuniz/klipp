...
export const logoClass = "relative grid size-8 shrink-0 place-items-center";
...
export const formSelectClass =
  "cursor-pointer rounded-md border border-(--border) bg-(--surface-sunk) px-3 py-2 text-sm text-(--text-h) shadow-(--inset-lo) hover:not-disabled:border-(--accent-border) disabled:cursor-not-allowed disabled:opacity-55";
